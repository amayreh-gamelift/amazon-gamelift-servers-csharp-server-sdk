...
namespace Aws.GameLift.Server.Model
{
    public class GameSession
    {
        ...
        public GameSession(CreateGameSessionMessage message)
        {
            ...
            this.Name = message.GameSessionName;
            this.MaximumPlayerSessionCount = message.MaximumPlayerSessionCount;
            this.Port = message.Port;
            this.IpAddress = message.IpAddress;
            this.GameSessionData = message.GameSessionData;
            this.MatchmakerData = message.MatchmakerData;
            this.GameProperties = message.GameProperties;
            this.DnsName = message.DnsName;
        }
    }
}