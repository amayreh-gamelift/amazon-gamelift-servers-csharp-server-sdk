...
namespace Aws.GameLift.Server
{
    ...
    /// game session that you want Amazon GameLift Servers to upload and store once the
    /// game session ends. This information is communicated to Amazon GameLift Servers in a
    /// ProcessReady() call.
    /// </summary>
    public class LogParameters
    {
        /// <summary>
        /// List of directory paths to game server log files you want Amazon GameLift
        /// Servers to store for future access. These files are generated by a server
