...
{
    /// <summary>
    /// This data type contains the set of parameters sent to Amazon GameLift Servers in a ProcessReady() method.
    /// </summary>
    public class ProcessParameters
    {
        ...
        /// <summary>
        /// Name of callback function that Amazon GameLift Servers invokes to activate a new game
        /// session. Amazon GameLift Servers calls this function in response to the client request CreateGameSession.
        /// The callback function takes a GameSession object defined in Amazon GameLift Servers API Reference.
        /// </summary>
        public OnStartGameSessionDelegate OnStartGameSession { get; set; }

        /// <summary>
        /// Name of callback function that Amazon GameLift Servers invokes to pass an updated
        /// game session object to the server process. Amazon GameLift Servers calls this function when a
        ...
        /// <summary>
        /// Name of callback function that Amazon GameLift Servers invokes to force the server
        /// process to shut down. After calling this function, Amazon GameLift Servers waits five minutes for
        ...
        /// <summary>
        /// Name of callback function that Amazon GameLift Servers invokes to request a health
        /// status report from the server process. Amazon GameLift Servers calls this function every 60 seconds.
        /// After calling this function Amazon GameLift Servers waits 60 seconds for a response, and if none is
