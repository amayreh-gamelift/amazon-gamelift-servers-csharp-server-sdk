...
#pragma warning restore S101
    {
        ...
        /// <summary>
        /// Initializes the server SDK. This method should be called on launch, before any other
        ...
        /// Amazon GameLift Servers managed EC2 instances.
        /// <list type="bullet">
        ...
        /// <item>The ID of the Amazon GameLift Servers fleet containing your Anywhere compute</item>
        /// <item>The authorization token generated by the Amazon GameLift Servers operation
...
#pragma warning restore S100, S101
        ...
        /// <summary>
        /// Initializes the server SDK. This method should be called on launch, before any other
        /// Amazon GameLift Servers related initialization occurs. Parameterless Version that can be used for servers hosted on
        /// Amazon GameLift Servers managed EC2 instances.
        /// </summary>
        /// <returns>If successful, returns a GenericOutcome object indicating that the server process is
        /// ready to call <see cref="ProcessReady"/>.
...
#pragma warning restore S100, S101
        ...
        /// <list type="bullet">
        /// <item>Names of callback methods, implemented in the game server code, that Amazon GameLift Servers invokes to
        /// communicate with the server process.</item>
        /// <item>Port number that the server process is listening on.</item>
        /// <item>Path to any game session-specific files that you want Amazon GameLift Servers to capture and store.</item>
        /// </list>
        /// </param>
        ...
        /// <summary>
        /// Notifies Amazon GameLift Servers that the server process is shutting down. This method should be called after
        ...
        /// <summary>
        /// Notifies Amazon GameLift Servers that the server is requesting a game session and is now ready to
        ...
        /// A server process takes this action after receiving an <c>onProcessTerminate()</c> callback from Amazon GameLift Servers.
        /// Amazon GameLift Servers may call <c>onProcessTerminate()</c> for the following reasons:
        /// <list type="number">
        /// <item>For poor health (the server process has reported port health or has not responded to Amazon GameLift Servers</item>
        ...
        /// <summary>
        /// Notifies the Amazon GameLift Servers service that a player with the specified player session ID has connected to the
        /// server process and needs validation. Amazon GameLift Servers verifies that the player session ID
        /// has reserved a player slot in the game session. Once validated,
        /// Amazon GameLift Servers changes the status of the player slot from <c>RESERVED</c> to <c>ACTIVE</c>.
        /// </summary>
        /// <param name="playerSessionId">Unique ID issued by Amazon GameLift Servers when a new player session is created.</param>
        /// <returns>Returns a GenericOutcome object consisting of success or failure with an error message.</returns>
        /// <example>
        /// <code>
        ...
        /// <summary>
        /// Notifies the Amazon GameLift Servers service that a player with the specified player session ID has disconnected from the
        /// server process. In response, Amazon GameLift Servers changes the player slot to available, which allows it to be
        ...
        /// By omitting <c>NextToken</c> and setting the <c>Limit</c> value to 10, Amazon GameLift Servers will return the first 10 player sessions
        ...
        /// feature</a>.
        /// <br/>
        /// This action is asynchronous. If new players are successfully matched, Amazon GameLift Servers delivers updated
        ...
        /// Amazon GameLift Servers will autogenerate one. </item>
        ...
        /// <summary>
        /// Deletes the instance of the server SDK on your resource. This removes all state
        /// information, stops heartbeat communication with Amazon GameLift Servers, stops game session management, and
        ...
        /// Environment.Exit(errorCode);
        ///
        /// // Shutdown and destroy the instance of the server SDK
